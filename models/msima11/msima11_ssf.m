function SSF = msima11_ssf(parms, y)
% msima11_ssf -- Takes the parameters sig2eta, sig2eps_j, p11, and p22 and 
% returns the state space form object SSF for the msima11 model. 
%
%****f* SSMWRS/models/msima11/msima11_ssf
%
% NAME
%   msima11_ssf -- Takes the parameters sig2eta, sig2eps_j, p11, and p22 and 
%   returns the state space form object SSF for the msima11 model. 
